...
export const searchResults: SearchResult[] = [
  { id: "r-1", type: "Radiology report", title: "RAD-4412", description: "CT Brain plain", meta: "Draft report", route: "/radiology/reporting" },
  { id: "r-2", type: "Radiology order", title: "RAD-4498", description: "MRI Spine screening", meta: "Scheduled", route: "/radiology/order-list" },
  { id: "r-3", type: "Radiology schedule", title: "Today modality list", description: "CT, MRI, X-ray, ultrasound queue", meta: "Live list", route: "/radiology/scheduling" },
