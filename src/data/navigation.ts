...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    status: "ready",
    children: [
      { id: "radiology-dashboard", label: "Dashboard", route: "/radiology/dashboard", status: "ready" },
      { id: "radiology-orders", label: "Orders", route: "/radiology/order-list", status: "ready" },
      { id: "radiology-front-office", label: "Front Office", route: "/radiology/front-office", status: "ready" },
      { id: "radiology-scan-room", label: "Scan Room", route: "/radiology/scan-room", status: "ready" },
      { id: "radiology-pacs", label: "PACS", route: "/radiology/pacs-studies", status: "ready" },
      { id: "radiology-reporting", label: "Reporting", route: "/radiology/reporting", status: "ready" },
      { id: "radiology-delivery-alerts", label: "Delivery & Alerts", route: "/radiology/delivery-alerts", status: "ready" },
      { id: "radiology-admin-mis", label: "Admin & MIS", route: "/radiology/admin-mis", status: "ready" },
    ],
  },
